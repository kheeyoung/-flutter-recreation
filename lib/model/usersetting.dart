...
class _UsersettingState extends State<UserSetting> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: header.basicHeader(context, "사용자 정보 최초 등록", _authentication),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          OutlinedButton(
                              onPressed: () async {
                                checkItem1 = await giftmethod.checkItemButtonMethod(
                                    firstGift, context);
                              },
                              child: Text(
                                "중복 확인",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          OutlinedButton(
                              onPressed: () async {
                                checkItem2 = await giftmethod.checkItemButtonMethod(
                                    secondGift, context);
                              },
                              child: Text(
                                "중복 확인",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          OutlinedButton(
                              onPressed: () async {
                                checkItem3 = await giftmethod.checkItemButtonMethod(
                                    thirdGift, context);
                              },
                              child: Text(
                                "중복 확인",
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        TextButton(
                          onPressed: () async {
                            if (checkInfo == false) {
                              List<String> text = await km.getInfoDoc();
                              myNotification.DialogInfo(context, text);
